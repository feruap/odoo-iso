...
docker exec odoo-staging odoo -c /etc/odoo/odoo.conf -d "$STAGING_DB" -u all --stop-after-init --db_host odoo-staging-db --db_port 5432 --db_user odoo --db_password odoo_staging_2024_secure
