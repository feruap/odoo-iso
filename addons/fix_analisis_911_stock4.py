...
# El quant está en -205; necesitamos +10 netos => agregar 215
Quant.sudo()._update_available_quantity(product, loc_amp, 215.0, lot_id=lot)
env.cr.commit()

check._compute_lot_qty_available()
print(f"lot_qty_available ahora: {check.lot_qty_available}")
