...
""",
    ...
    'license': 'LGPL-3',
    'depends': [
        'mail', 'contacts', 'amunet_quality',
        'amunet_programa_auditoria_proveedores',
        'amunet_plan_auditoria_proveedores',
        'amunet_apertura_cierre_prov',
        'amunet_checklist_auditoria_prov',
    ],
    'data': [
        ...
        'views/menu_proveedores_overrides.xml',
