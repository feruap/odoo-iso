...
export class AppsMenu extends Component {
    setup() {
        super.setup();
        this.state = useState({open: false, company: {}});
        ...
        onWillStart(async () => {
            ...
            try {
                ...
                console.error("Failed to fetch company data for local home menu", e);
                // Fallback to basic session data if ORM fails
                this.state.company = {
                    name: "Amunet S.A. de C.V.",
                    contact_address: "25 Sur 3107, Altos 4. Colonia Benito Juárez, C.P. 72410. Puebla, Puebla, México",
                    website: "www.amunet.com.mx"
                };
            }
        });
