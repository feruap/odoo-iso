...
class MrpProduction(models.Model):
    ...
    def _amunet_qc_firma_aprobar(self):
        ...
        # las mismas piezas.
        #
        # Este nunca llego a generar un documento (0 en produccion y 0 en
        # staging), asi que no se pierde historia. El metodo se conserva por si
        # se quisiera volver, pero ya no se llama.
        #
