...
class MrpProduction(models.Model):
    ...
    def _amunet_sellar_fecha_fabricacion(self):
        ...
        """
        for orden in self:
            # Se usa la fecha de CIERRE de la orden, confirmado por Mery el
            # 2026-09-01. Se probo con date_start y se descarto: la fecha buena
            # es cuando la orden se cierra, no cuando arranca.
