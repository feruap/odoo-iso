...
class AmunetAmefAuditLog(models.Model):
    _name = 'amunet.amef.audit.log'
    _description = 'Log de auditoría AMEF (append-only)'
    _order = 'create_date desc, id desc'

    amef_id = fields.Many2one(
        'amunet.amef', string='AMEF', required=True, index=True, ondelete='restrict')
