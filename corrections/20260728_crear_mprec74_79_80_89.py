"""
Crea 4 productos nuevos usando huecos disponibles en la secuencia MPREC.
Aprobado por Karla Fernanda Palma Ramos (almacen.mp) el 2026-07-28.
"""
...
productos = [
    ('MPREC74', 'Ácido nitriloacético',           uom_g),
    ('MPREC79', 'Hidróxido de amonio',             uom_ml),
    ('MPREC80', 'SDS',                             uom_g),
    ('MPREC89', 'Calceína (indicador fluorescente)', uom_g),
]
