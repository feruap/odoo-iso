...
Crea o corrige producto SPHMC76 basado en SPHMC75.
...
if r:
    ...
    if has_image(r['id']):
        print(f"[{db}] '{NEW_CODE}' already correct with image — done.")
...
r=cur.fetchone()
if r:
    print(f"[{db}] Wrong code found (tmpl_id={r['id']}) — fixing...")
    fix_codes(r['id'],r['pp_id'])
