...
# Anexo 1 — Pirámide documental (diagrama de texto por niveles)
...
# Anexo 2 — Estructura de los documentos (tabla)
...
# Anexo 3 — Estructura del encabezado
...
anexo3 += '''
<table border="1" style="width:100%;border-collapse:collapse;font-size:inherit;margin:8px 0;">
  <tr>
    <td rowspan="4" style="padding:8px;text-align:center;width:15%;background:#f5f5f5;"><strong>1.<br/>Logo</strong></td>
    <td rowspan="4" style="padding:8px;text-align:center;width:25%;background:#f5f5f5;"><strong>2.<br/>Nombre de la empresa</strong></td>
    <td colspan="2" style="padding:6px;"><strong>3. Área donde aplica</strong></td>
  </tr>
  <tr>
    <td style="padding:6px;"><strong>4. Tipo de documento / Nombre del documento</strong></td>
    <td style="padding:6px;"><strong>5. Código</strong></td>
  </tr>
  <tr>
    <td style="padding:6px;"></td>
    <td style="padding:6px;"><strong>6. Versión</strong></td>
  </tr>
  <tr>
    <td style="padding:6px;"><strong>9. Fecha de Emisión</strong></td>
    <td style="padding:6px;"><strong>7. Sustituye &nbsp;&nbsp; 8. Página &nbsp;&nbsp; 10. Próxima Revisión</strong></td>
  </tr>
</table>
<p><strong>Donde:</strong></p>
<ul>
...
# Anexo 4 — Sección de firmas
anexo4 = hdr(4, 'Sección de firmas: Colocar únicamente en la primera página del documento')
anexo4 += '''
<p>Colocar el siguiente recuadro en Manuales y/o Procedimientos Normalizados de Operación:</p>
<table border="1" style="width:100%;border-collapse:collapse;font-size:inherit;margin:8px 0;">
  <tr>
    <td style="padding:8px;text-align:center;width:25%;background:#f5f5f5;"><strong>Documento Original</strong></td>
    <td style="padding:8px;text-align:center;width:25%;background:#f5f5f5;"><strong>Copia Controlada No.</strong></td>
    <td style="padding:8px;text-align:center;width:25%;background:#f5f5f5;"><strong>Documento de Consulta</strong></td>
    <td style="padding:8px;text-align:center;width:25%;background:#f5f5f5;"><strong>Documento Cancelado</strong></td>
  </tr>
  <tr>
...
env.cr.commit()
print('OK — Anexos 1, 2, 3 y 4 completos en PNOGE-001')
