...
# 0) Nombre del producto -> "NT-proBNP" (ambos idiomas; el shell usa en_US)
tmpl.with_context(lang='en_US').write({'name': 'NT-proBNP'})
tmpl.with_context(lang='es_MX').write({'name': 'NT-proBNP'})
