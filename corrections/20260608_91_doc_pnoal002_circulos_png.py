import zipfile, base64, html as html_mod, json
...
act6 = (
    ...
    '<p>Etiqueta circular color verde para producto aprobado. ' + c_verde + '</p>'
    '<p>Etiqueta circular color rojo para producto rechazado. ' + c_rojo + '</p>'
...
env.cr.commit()
print('OK — círculos PNG amarillo/verde/rojo en actividades 3/6/7')
