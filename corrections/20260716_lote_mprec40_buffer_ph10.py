...
tmpl = env['product.template'].search([('default_code', '=', 'MPREC40')])
...
factory = env['amunet.lot.factory'].search([('name', '=', '010322')], limit=1)
if not factory:
    factory = env['amunet.lot.factory'].create({'name': '010322'})
...
env.cr.commit()
print("Inventario: 100 ml de REC40072201 en", ubicacion.complete_name)
