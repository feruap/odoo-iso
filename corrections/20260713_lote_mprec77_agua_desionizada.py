...
tmpl = env['product.template'].search([('default_code', '=', 'MPREC77')])
...
factory = env['amunet.lot.factory'].search([('name', '=', '150224')], limit=1)
if not factory:
    factory = env['amunet.lot.factory'].create({'name': '150224'})
...
lote = env['stock.lot'].create({
    ...
    'expiration_date': '2029-02-01 00:00:00',
})
...
env.cr.commit()
print("Inventario: 400 ml de REC77072501 en", ubicacion.complete_name)
